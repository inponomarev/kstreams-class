...
0. На вашей машине должны быть установлены: Docker, Java 8, Maven, IntelliJ IDEA (c Lombok-плагином).
...
<img align="left" src="conduktor1.png" width="400px">

6. Войдите в кластер, должна появиться примерно следующая картинка!

<img align="left" src="conduktor2.png" width="400px" alt="conduktor screenshot"> 
